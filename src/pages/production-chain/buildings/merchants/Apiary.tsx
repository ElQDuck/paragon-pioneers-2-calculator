...
export const APIARY_INFO: Building = {
...
export const Apiary = (props: { count: number }) => {
  ...
  return (
    <Box sx={{ ...BuildingGroup, flexDirection: globalInvertBuildingChainOrder.value ? 'row-reverse' : 'row' }}>
      ...
      <Box sx={{ ...ProviderBoxStyle, alignItems: globalInvertBuildingChainOrder.value ? 'end' : 'start' }}>
        ...
        >
          <Grass count={props.count * APIARY_INFO.ConsumePerIteration.get('Gras')!} />
        </Paper>
      </Box>
...
export const ApiaryButton = (props: { updateProductionChanFunction: Function }) => {
  return (
    <BuildingButton
