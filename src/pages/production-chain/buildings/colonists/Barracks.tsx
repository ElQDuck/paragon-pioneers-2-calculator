...
import { COPPER_ARMORY_INFO, CopperArmory } from './CopperArmory'
...
export const BARRACKS_INFO: Building = {
  IterationTimeInSeconds: ITERATION_TIME_IN_SECONDS,
  IterationTimeInDecimal: ITERATION_TIME_IN_SECONDS / 60,
  ConsumePerIteration: CONSUME_PER_ITERATION,
  ConsumePerMinute: new Map<string, number>([
    ['Militia', CONSUME_PER_ITERATION.get('Militia')! / ITERATION_TIME_IN_DECIMAL],
    ['CopperSword', CONSUME_PER_ITERATION.get('CopperSword')! / ITERATION_TIME_IN_DECIMAL],
  ]),
  ProducePerIteration: PRODUCE_PER_ITERATION,
  ProducePerMinute: PRODUCE_PER_ITERATION / ITERATION_TIME_IN_DECIMAL,
}

export const Barracks = (props: { count: number }) => {
...
export const BarracksButton = (props: { updateProductionChanFunction: Function }) => {
  return (
    <BuildingButton
