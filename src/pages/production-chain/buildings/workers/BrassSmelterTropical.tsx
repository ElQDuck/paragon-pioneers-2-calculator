...
import BrassSmelterTropicalIcon from '../../../../assets/icons/buildings/workers/BrassSmelterTropical.png'
import {
  BuildingGroup,
  BuildingImageSize,
  ConsumerPaperStyle,
...
export const BRASS_SMELTER_TROPICAL_INFO: Building = {
...
export const BrassSmelterTropical = (props: { count: number }) => {
    ...
    <Box sx={{ ...BuildingGroup, flexDirection: globalInvertBuildingChainOrder.value ? 'row-reverse' : 'row' }}>
      ...
      >
        <Box sx={SingleBuildingWithCount}>
          <Box
            component="img"
            src={BrassSmelterTropicalIcon}
            title={capitalCase(BrassSmelterTropical.name)}
            alt={BrassSmelterTropical.name}
      ...
      <Box sx={{ ...ProviderBoxStyle, alignItems: globalInvertBuildingChainOrder.value ? 'end' : 'start' }}>
          ...
          <AlternativeCombinationProvider
            combinationList={[
              <CopperSmelterTropical
                count={
                  props.count *
                  (BRASS_SMELTER_TROPICAL_INFO.ConsumePerMinute.get('CopperIngot')! /
        ...
        >
          <ZincSmelter
            count={
              props.count *
              (BRASS_SMELTER_TROPICAL_INFO.ConsumePerMinute.get('ZincIngot')! / ZINC_SMELTER_INFO.ProducePerMinute)
            }
          />
        </Paper>
      </Box>
...
export const BrassSmelterTropicalButton = (props: { updateProductionChanFunction: Function }) => {
  return (
    <BuildingButton
      buttonIcon={BrassSmelterTropicalIcon}
      buildingElement={BrassSmelterTropical}
