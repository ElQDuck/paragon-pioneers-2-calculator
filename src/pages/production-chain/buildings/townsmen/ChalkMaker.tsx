...
const CONSUME_PER_ITERATION = new Map<string, number>([['Limestone', 1]])
export const CHALK_MAKER_INFO: Building = {
...
export const ChalkMaker = (props: { count: number }) => {
...
export const ChalkMakerButton = (props: { updateProductionChanFunction: Function }) => {
  return (
    <BuildingButton
