export const UpdateBuildingSummery = (building: string, value: number, context: [Map<string, number>, React.Dispatch<React.SetStateAction<Map<string, number>>>], oldValueState: [number, React.Dispatch<React.SetStateAction<number>>]) => {
